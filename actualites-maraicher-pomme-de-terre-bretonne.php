            ...
            <div class="pagewidth">
              <div class="articlesactusfull">
                ...
                <article class="reseauxactuscentre">
                    <p class="titreactuscentre"><img src="img-webp/pomme-de-terre-bretonne-actualites-full.webp" alt="Pomme de terre bretonne"></p>
                    <h5>Quelle pomme de terre pour les frites, la purée... ?</h5>
                    <p class="datearticlesactus">8 novembre 2020</p>
