            ...
            <div class="pagewidth">
              <div class="articlesactusfull">
                ...
                <article class="reseauxactuscentre">
                    <p class="titreactuscentre"><img src="img-webp/citrouille-actualites-full.webp" alt="Potiron Marché d Auray"></p>
                    <h5>Il y en aura pour tout le monde</h5>
                    <p class="datearticlesactus">4 novembre 2020</p>
